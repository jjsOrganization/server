...
import com.jjs.ClothingInventorySaleReformPlatform.domain.user.dto.request.LogoutDto;
import com.jjs.ClothingInventorySaleReformPlatform.domain.user.dto.request.ReissueDto;
import com.jjs.ClothingInventorySaleReformPlatform.domain.user.dto.request.UserLoginRequestDto;
import com.jjs.ClothingInventorySaleReformPlatform.domain.user.dto.response.*;
import com.jjs.ClothingInventorySaleReformPlatform.domain.user.dto.updateRequest.DesignerUpdateDTO;
import com.jjs.ClothingInventorySaleReformPlatform.domain.user.dto.updateRequest.PurchaserUpdateDTO;
import com.jjs.ClothingInventorySaleReformPlatform.domain.user.dto.updateRequest.SellerUpdateDTO;
...
import com.jjs.ClothingInventorySaleReformPlatform.domain.user.repository.SellerRepository;
...
import com.jjs.ClothingInventorySaleReformPlatform.global.common.response.AuthResponseDTO;
import com.jjs.ClothingInventorySaleReformPlatform.domain.user.dto.request.DesignerDTO;
import com.jjs.ClothingInventorySaleReformPlatform.domain.user.dto.request.PurchaserDTO;
import com.jjs.ClothingInventorySaleReformPlatform.domain.user.dto.request.SellerDTO;
...
import com.jjs.ClothingInventorySaleReformPlatform.global.error.exception.BusinessException;
import com.jjs.ClothingInventorySaleReformPlatform.global.jwt.dto.TokenDto;
...
public class UserService {
    ...
    public PurchaserInfoResponse getPurchaserInfo() {
        ...
        PurchaserInfo purchaserInfo = purchaserRepository.findByEmail(currentUsername)
                .orElseThrow(() -> new UsernameNotFoundException("판매자 정보를 찾을 수 없습니다: " + currentUsername));
