...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, String> consumerFactory() {
        Map<String, Object> props = new HashMap<>(); // kafka 컨슈머 설정을 저장할 저장소.
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "localhost:9092"); // kafka 클러스터와 연결하기 위한 서버 목록 지정
        props.put(ConsumerConfig.GROUP_ID_CONFIG, groupId); // 컨슈머가 속할 컨슈머 그룹의 ID를 지정
        ...
        return new DefaultKafkaConsumerFactory<>(props); // 설정된 프로퍼티를 사용하여 인스턴스를 생성하고 반환.
